...
Window_Credits.prototype.refresh = function() {
	...
	// window height
	// En MZ, usamos .padding directamente
...
// Fuerza el escalado en cada frame para asegurar que cubra todo
Sprite_CredBg.prototype.update = function() {
    Sprite.prototype.update.call(this);
    if (this.opacity < 255) this.opacity += 5;
    
    if (this.bitmap && this.bitmap.width > 0) {
        var scaleX = Graphics.boxWidth / this.bitmap.width;
        var scaleY = Graphics.boxHeight / this.bitmap.height;
